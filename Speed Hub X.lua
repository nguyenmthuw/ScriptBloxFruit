...
local Window = SpeedHubX:CreateWindow({
    Title = " A bad girl and good man (i like he)| ".._G.Version,
    SubTitle = "by @ng_mthuw and @_vitor190",
    TabWidth = 160,
...
local EnableFarm = Tabs.Main:AddToggle("EnableFarm_Toggle", {Title = "Auto Farm Level", Default = false })
Options.EnableFarm_Toggle:SetValue(false)

EnableFarm:OnChanged(function(value)
